...
/***/ function(module, exports, __webpack_require__) {
	...
	var MusicPlayer = React.createClass({
	  ...
	  makeAudio: function makeAudio(title, i) {
	    var mp3 = "audio/" + title + ".mp3";
	    var wav = "audio/" + title + ".wav";
	    return React.createElement(
	      'audio',
	      { ref: title, key: i },
	      React.createElement('source', { src: mp3 }),
	      React.createElement('source', { src: wav }),
	      React.createElement(
	        'p',
	        null,
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      null,
	      audioList,
	      React.createElement(SongList, { titles: this.state.songs, chosen: this.state.chosen, select: this.select, playPause: this.playPause })
	    );
	  }
	});
	...
	var Control = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('img', { src: 'img/pause.png', height: '42', width: '42', onClick: this.props.playPause })
	    );
	  }
	});
	...
	var SongList = React.createClass({
	  ...
	  getSong: function getSong(title, i) {
	    if (title === this.props.chosen) {
	      return React.createElement(Song, { name: title, class_name: 'song chosen_song', select: this.props.select, key: i });
	    }
	    return React.createElement(Song, { name: title, class_name: 'song', select: this.props.select, key: i });
	  },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(Control, { playPause: this.props.playPause })
	      ),
	      listItems
	    );
	  }
	...
	var Song = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { onClick: this.selectThis, className: this.props.class_name },
	      React.createElement(
	        'p',
	        null,
	        this.props.name
	...
	var DrumMachine = React.createClass({
	  ...
	  makeAudio: function makeAudio() {
	    ...
	    for (var i = 0; i < this.state.effects.length; i++) {
	      for (var j = 0; j < this.state.numBeats; j++) {
	        ...
	        var mp3 = "audio/" + title + ".mp3";
	        var effect = React.createElement(
	          'audio',
	          { ref: title + j, key: title + j, muted: true },
	          React.createElement('source', { src: mp3 }),
	          React.createElement(
	            'p',
	            null,
	  ...
	  playPauseBeat: function playPauseBeat() {
	    if (this.state.id) {
	      this.endBeat();
	  ...
	  setTempo: function setTempo(new_tempo) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      null,
	      effectsList,
	      React.createElement(EffectList, { titles: this.state.effects, setTempo: this.setTempo,
	...
	var EffectList = React.createClass({
	  ...
	  getEffects: function getEffects() {
	    ...
	    for (var i = 0; i < this.props.titles.length; i++) {
	      ...
	      effect_group.push(React.createElement(
	        'div',
	        { className: 'drumName' },
	        ' ',
	        React.createElement(
	      ...
	      for (var j = 0; j < this.props.numBeats; j++) {
	        var title = kind + j;
	        if (j % 4 == 3) {
	          var effect = React.createElement(Effect, { name: title, key: title, toggle: this.props.toggle, endBeat: true });
	        } else {
	          var effect = React.createElement(Effect, { name: title, key: title, toggle: this.props.toggle, endBeat: false });
	        }

	        effect_group.push(effect);
	      }
	      effects.push(React.createElement(
	        'div',
	        { className: 'effectGroup' },
	        effect_group
	      ));
	      effects.push(React.createElement(
	        'p',
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'effectHeader' },
	        React.createElement(
	          'h3',
	          null,
	          ' CREATE YOUR OWN BEAT! '
	        ),
	        React.createElement('img', { src: 'img/pause.png', width: '42', height: '42', onMouseDown: this.props.playPauseBeat })
	      ),
	      listItems,
	      React.createElement(Metronome, { paused: this.props.paused, currentBeat: this.props.currentBeat, numBeats: this.props.numBeats }),
	      React.createElement(TapTempo, { setTempo: this.props.setTempo })
	    );
	  }
	});
	...
	var Effect = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { ref: this.props.name, className: class_name, onClick: this.toggleThis },
	...
	var Metronome = React.createClass({
	  ...
	  makeMetronome: function makeMetronome() {
	    var metronomeBoxes = [];
	    for (var i = 0; i < this.props.numBeats; i++) {
	      ...
	      metronomeBoxes.push(React.createElement(MetronomeBox, { class_name: class_name }));
	    }
	...
	var TapTempo = React.createClass({
	  ...
	  updateTempo: function updateTempo() {
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'tapTempoContainer' },
	      React.createElement(
	        'p',
	        { className: 'tapTempoHeader' },
	        'Tap Tempo '
	      ),
	      React.createElement('input', { type: 'text', ref: 'tapTempo', className: 'tapTempo', onKeyDown: this.updateTempo }),
	      React.createElement(
	        'p',
	        { className: 'instructions' },
	        'Click Box & Tap Any Key In Beat (Reset: Wait 2 Seconds)'
	      )
	    );
	  }
	});

	ReactDOM.render(React.createElement(App, null), document.getElementById("musicPlayer"));
